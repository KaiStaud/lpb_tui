...
var dryRunCmd = &cobra.Command{
	Use:   "dryRun",
	Short: "Simulates selected profile without movement",
	Long: `Selected profile gets executed without actuall arm
	movent. Both bus systems behave as in normal mode`,
